  ...
  return (
    <div className="py-8 px-20 max-w-7xl flex justify-center items-center mx-auto">
      <div>
        ...
        <h2 className="text-xl font-semibold mt-4 dark:text-slate-300">
          Interpretation
        </h2>
        <p className="dark:text-slate-400">
        ...
        <ul className="list-disc ml-8 dark:text-slate-400">
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to BluThumb.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Country</strong> refers to: Wisconsin, United States
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to BluThumb, accessible from{" "}
              <a
                href="https://www.bluthumb.io"
                rel="external nofollow noopener"
                target="_blank"
                className="text-blue-700 dark:text-blue-600 hover:underline"
              >
                https://www.bluthumb.io
              </a>
            </p>
          </li>
          <li>
        ...
        <ul className="list-disc ml-8 dark:text-slate-400">
          <li>
            <p className="dark:text-slate-400">Email address</p>
          </li>
          <li>
            <p className="dark:text-slate-400">Usage Data</p>
          </li>
        </ul>
        <h3 className="text-lg font-medium mt-3 dark:text-slate-300">
          Usage Data
        </h3>
        <p className="dark:text-slate-400">
        ...
        <p className="dark:text-slate-400">
          ...
          us by email: bluthumbio@gmail.com
        </p>
      </div>
    </div>
  );
