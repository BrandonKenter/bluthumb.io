...
const DifficultyDropdown = ({ filterState, setFilterState }) => {
  ...
  return (
    <div className="text-right z-10 p-1">
      <Menu as="div" className="relative inline-block text-left">
        ...
        >
          <Menu.Items className="font-semibold absolute right-0 mt-2 w-36 origin-top-right divide-y divide-slate-100 rounded-md bg-slate-100 dark:bg-slate-700 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
            <div className="px-1 py-1">
              ...
              <Menu.Item className="transition duration-100 text-orange-500">
                {({ active }) => (
                  <button
                    onClick={() => {
